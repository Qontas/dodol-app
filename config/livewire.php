...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        // PIN ke 'local' (disk server), JANGAN ikut FILESYSTEM_DISK. Kalau temp upload
        // jatuh ke disk 's3' (R2 saat FILESYSTEM_DISK=s3 di produksi), Livewire beralih
        // ke presigned PUT LANGSUNG dari browser ke R2 → butuh CORS di bucket; R2 tanpa
        // CORS → browser blokir → "failed to upload" (blocker input kios di HP).
        // Dengan 'local': temp upload masuk ke server dulu (tanpa CORS), lalu file
