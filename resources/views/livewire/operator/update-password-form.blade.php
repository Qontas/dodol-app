...
<section>
    ...
    <form wire:submit="updatePassword" class="mt-6 space-y-6">
        <div>
            <label for="update_password_current_password" class="block text-sm font-bold text-slate-900">{{ __('Current Password') }}</label>
        ...
        <div>
            <label for="update_password_password" class="block text-sm font-bold text-slate-900">{{ __('New Password') }}</label>
        ...
        <div>
            <label for="update_password_password_confirmation" class="block text-sm font-bold text-slate-900">{{ __('Confirm Password') }}</label>
